...
function initMap() {  
  ...
  var prev_infowindow = false;
   ...
   var MarkandInfo = (marker, content, careerB, preInfo) => {
    var prev_infowindow = preInfo
...
MarkandInfo({ lat: 36.992993, lng: 126.828592},'<h1>NAVY</h1>', careerB[0], prev_infowindow)
MarkandInfo({ lat: 35.2283169018659, lng: -80.84258464268434} ,'<h1>AMERICA</h1>', careerB[1], prev_infowindow)
MarkandInfo({ lat: 28.724931954586644, lng: 77.22757668973156}, '<h1>INDIA</h1>', careerB[2], prev_infowindow)
MarkandInfo({ lat: 35.1731631, lng: 129.127601}, '<h1>COLLEGE</h1>', careerB[3], prev_infowindow)
MarkandInfo({ lat: 35.1765759, lng: 129.125176}, '<h1>COMPANY</h1>', careerB[4], prev_infowindow)
